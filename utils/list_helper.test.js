...
describe('total likes', () => {
  ...
  test('of list with one item is likes of that item', () => {
    const blogs = [
      {
...
describe('most blogs', () => {
  test('returns the right author with right blog count', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
    ...
    expect(mostBlogs).toHaveProperty('author', 'Robert C. Martin');
    expect(mostBlogs).toHaveProperty('blogs', 3);
  });
  ...
  test('works with a one-item list', () => {
    ...
    const mostBlogs = listHelper.mostBlogs(blogs);
    expect(mostBlogs).toHaveProperty('author', 'Robert C. Martin');
    expect(mostBlogs).toHaveProperty('blogs', 1);
  });
...
describe('most likes', () => {
  test('returns the right author with right likes count', () => {
    const blogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
